var FPROM = (function () {
    ...
    function p() {
        var n, e;
        (c.domain = ((n = _((e = window.location.hostname), 3)), (e = _(e, 4)), n.length > e.length ? n : e)),
            (c.test_mode = "1" === x("test_mode")),
            c.test_mode || ((c.cookie_tid = v(i)), (c.cookie_ref_id = v(o)), (c.details = g(v(t), !0))),
    ...
    function w(n, e, t, i) {
        var o,
            r = ((o = n), (n = e), "withCredentials" in (e = new XMLHttpRequest()) ? e.open(o, n) : "undefined" != typeof XDomainRequest ? (e = new XDomainRequest()).open(o, n) : (e = null), e);
        r
            ? ((r.onload = function () {
                  m(i) && i(r);
              }),
    ...
    return (
        (T.getDetails = T.details),
        {
            ...
            _fpr: (function (e) {
                ...
                if (window.fpr) for (; 0 < window.fpr.q.length; ) n.apply(e, window.fpr.q.shift());
                return n;
            })(T),
            data: c,
        }
